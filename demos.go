...
func debugstatfunct(args Args) {
	...
	valuefield := 3
	genstats(args, "demotext for log", "conf_stat_unique_PerDay_hits", "stmt_unique_PerDay_hits", parameters, tableheaders, xaxisfields, valuefield, "raw hits", "day",4,8,"week")
}
