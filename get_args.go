...
type Linegraph4weekconfig struct {
	Linegraph_compare_x_days_weeks_months_enabled     bool
	...
	Linegraph_compare_x_days_weeks_months_index_order string
...
func argblock(cfg *ini.File, configname string, whichstats string, outputs Output) (Statconfig, error) {
	...
	if strings.Contains(whichstats, "4") {
		linegraph_compare_x_days_weeks_months_enabled, _ := cfg.Section(configname).Key("linegraph_compare_x_days_weeks_months_enabled").Bool()
		if stat_enabled && linegraph_compare_x_days_weeks_months_enabled {
			var mylinegraph4weekconfig Linegraph4weekconfig
			mylinegraph4weekconfig.Linegraph_compare_x_days_weeks_months_enabled = true
			mylinegraph4weekconfig.Linegraph_compare_x_days_weeks_months_title = splice_number_of_days_detailed_in(cfg.Section(configname).Key("linegraph_compare_x_days_weeks_months_title").String(), outputs.Number_of_days_detailed)
			mylinegraph4weekconfig.Linegraph_compare_x_days_weeks_months_description = splice_number_of_days_detailed_in(cfg.Section(configname).Key("linegraph_compare_x_days_weeks_months_description").String(), outputs.Number_of_days_detailed)
			...
			mylinegraph4weekconfig.Linegraph_compare_x_days_weeks_months_index_order = cfg.Section(configname).Key("linegraph_compare_x_days_weeks_months_index_order").String() 
