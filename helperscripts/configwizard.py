...
def fill_allstats_sections():
	...
	statdb = {
		...
		'conf_stat_unique_PerHour_ReferringUrls': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Number of unique per hour over the last |number_of_days_detailed| days', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count of all unique succesfull referrers', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'unique succesfull referrer = the first hit of a unique user in a timeframe of |number_of_days_detailed|. Only the first actual hit is counted, not repeat visits!| We limit the output to the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you\'ll get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they\'ll never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_PerHour_ReferringUrls_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'table unique referrers per hour over last |number_of_days_detailed| days', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'referrers', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '1', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
		...
		'conf_stat_unique_PerHour_RefferingUrlsNoEmptyOrSelf': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Number of unique per hour over the last |number_of_days_detailed| days, excluding empty or owndomain', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count of all unique succesfull referrers, excluding empty or owndomain.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'unique succesfull referrer = the first hit of a unique user in a timeframe of |number_of_days_detailed|. Only the first actual hit is counted, not repeat visits!| We limit the output to the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you\'ll get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they\'ll never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_PerHour_RefferingUrlsNoEmptyOrSelf_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'table unique referrers per hour over last |number_of_days_detailed| days, excluding empty or owndomain', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'referrers', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '4', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
			'linegraph_description' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph description'},
			'linegraph_filename' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph filename'},
		...
		'conf_stat_unique_PerHour_RefferingUrlsNoEmptyOrSelfOnlyTld': {
			...
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Number of unique per hour over the last |number_of_days_detailed| days, excluding empty or owndomain', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count of all unique succesfull referrer\'s tlds, excluding empty or owndomain.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'unique succesfull referrer = the first hit of a unique user in a timeframe of |number_of_days_detailed|. Only the first actual hit is counted, not repeat visits!| We limit the output to the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you\'ll get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they\'ll never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_PerHour_RefferingUrlsNoEmptyOrSelfOnlyTld_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'table unique referrers per hour over last |number_of_days_detailed| days, excluding empty or owndomain', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'referrers', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '5', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
			'linegraph_description' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph description'},
			'linegraph_filename' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph filename'},
		...
		'conf_stat_raw_XDaysTotal_HitsFromSearchEngines': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Number of raw referring search engines hits over th last |number_of_days_detailed| days', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count of all raw succesfull referrering search engines.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'raw succesfull referrer = the first hit of a unique user in a timeframe of |number_of_days_detailed|. Only the first actual hit is counted, not repeat visits!| We limit the output to the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you\'ll get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they\'ll never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'raw_XDaysTotal_HitsFromSearchEngines_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'table raw referrering search engines hits over last |number_of_days_detailed| days', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'searchegines', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '2', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
			'linegraph_description' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph description'},
		...
		'conf_stat_unique_XDaysTotal_HitsFromSearchEngines': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Number of unique referring search engines hits over th last |number_of_days_detailed| days', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count of all unique succesfull referrering search engines.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'unique succesfull referrer = the first hit of a unique user in a timeframe of |number_of_days_detailed|. Only the first actual hit is counted, not repeat visits!| We limit the output to the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you\'ll get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they\'ll never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_XDaysTotal_HitsFromSearchEngines_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'table unique referrering search engines hits over last |number_of_days_detailed| days', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'searchegines', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '1', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
		...
		'conf_stat_unique_XDaysTotal_Entrypages': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Count nb of times a page was an entry page over the last |number_of_days_detailed| days', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count how many times each page was requested as an entry page over the last |number_of_days_detailed| days.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'It is possible that the entry page = the exit page!!!|the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you will get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they will never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_XDaysTotal_Entrypages_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'entry page count for |number_of_days_detailed| days', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'entry and exit pages', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '1', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
			'linegraph_description' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph description'},
		...
		'conf_stat_unique_XDaysTotal_Exitpages': {
			'enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enabled?'},
			'table_enabled': {'type': 'bool', 'validate': '', 'default': 'true', 'helpmessage': 'enable table output?'},
			'table_title': {'type': 'string', 'validate': '', 'default': 'Count nb of times a page was an exit page over the last |number_of_days_detailed| days', 'helpmessage': 'table title'},
			'table_description' : {'type': 'string', 'validate': '', 'default': 'Count how many times each page was requested as an exit page over the last |number_of_days_detailed| days.', 'helpmessage': 'table description'},
			'table_pagecontent' : {'type': 'string', 'validate': '', 'default': 'It is possible that the entry page = the exit page!!!|the number of days that were defined in your config.ini file with a sliding window (so if you run this tool at 15:34 you will get stats untill 15:34 x days ago).', 'helpmessage': 'table pagecontent'},
			'table_pagefooter' : {'type': 'string', 'validate': '', 'default': 'only hits that were actually loaded are shown, so if you filtered out certain lines in your config.ini they will never be shown!', 'helpmessage': 'table pagefooter'},
			'table_filename' : {'type': 'string', 'validate': '', 'default': 'unique_XDaysTotal_Exitpages_table.html', 'helpmessage': 'table filename'},
			'table_index_name' : {'type': 'string', 'validate': '', 'default': 'exit page count for |number_of_days_detailed| days', 'helpmessage': 'table indexfile linktext'},
			'table_index_group' : {'type': 'string', 'validate': '', 'default': 'entry and exit pages', 'helpmessage': 'table indexfile group'},
			'table_index_order' : {'type': 'int', 'validate': '', 'default': '2', 'helpmessage': 'table indexfile order'},
			'linegraph_enabled' : {'type': 'bool', 'validate': '', 'default': 'false', 'helpmessage': 'enable linegrapht output?'},
			'linegraph_title' : {'type': 'string', 'validate': '', 'default': '', 'helpmessage': 'linegraph title'},
