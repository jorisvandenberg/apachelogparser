...
func noaggregation_nbdaysdetailed_uniqueperday_2xx_3xx(args args) {
	...
	PreChartText = ""
	PostChartText = ""
	createlinegraph(XValues_linegraph, YValues_linegraph, "line graph of the unique hits with status 2xx and 3xx per day", "Count of all unique succesfull hits (filtering out all 4xx and 5xx return codes).", args, "noaggregation_nbdaysdetailed_uniqueperday_2xx_3xx_linegraph.html")
